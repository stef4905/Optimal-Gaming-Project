...
namespace Optimal_Gaming_Class_Library.Control_Layer.SpecsController
{
    public class ComponentHDDController
    {
        ...
        /// </summary>
        /// <param name="obj">HDD object to insert into database</param>
        ...
        /// </summary>
        /// <param name="id">ObjectId for the HDD document</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Updates the given HDD object in the database
        /// </summary>
        /// <param name="obj">HDD object to update in the database</param>
        ...
        /// <summary>
        /// Deletes the given HDD object in the database if it exists
        /// </summary>
