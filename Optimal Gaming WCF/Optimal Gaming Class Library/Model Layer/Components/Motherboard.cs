...
namespace Optimal_Gaming_Class_Library.Model_Layer.Components
{
    public class Motherboard
    {
        ...
        public string ProcessorSocker { get; set; } // Socket | AM4, LGAxxxx
        ...
        public string[] ExpansionsOpnenigs { get; set; } // Possible expansions of the motherboard such as 1 X CPU, 4 X DIMM 288-pins, 1 X PCIe 3.0 x16 etc
        ...
        public Motherboard(string name, double price, string brandName, Size Size, string formFactor, string chipset, string processorSocker, string ramTechnology, int maxSupportedRam, string ramBusClock, int ramSlots, string audioType, string audioCodec, string networkInterface, string[] expansionsOpnenigs, string[] storageInterface, string[] @interface, string[] internInterface, string powerAdapter, string biosType)
        {
            Name = name;
            Price = price;
            BrandName = brandName;
            ...
            Chipset = chipset;
            ProcessorSocker = processorSocker;
            ...
            ExpansionsOpnenigs = expansionsOpnenigs;
